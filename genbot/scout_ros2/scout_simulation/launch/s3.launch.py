...
def generate_launch_description():
    ...
    spawn_urdf_node = Node(
        ...
        arguments=[
            ...
            "-x", "0.0", "-y", "0.9", "-z", "0.07", "-Y", "0.0"  # Initial spawn position
        ],
        output="screen",
        parameters=[
            {'use_sim_time': True},
    ...
    gz_bridge_node = Node(
        ...
        arguments=[
            ...
            "/cmd_vel_ped@geometry_msgs/msg/Twist@gz.msgs.Twist",
            "/mode_position_ped@std_msgs/msg/Bool@gz.msgs.Boolean",
            "/pose_control_ped@geometry_msgs/msg/Pose@gz.msgs.Pose",
            ...
            "/ped_local_pose@geometry_msgs/msg/Pose@gz.msgs.Pose", 
            "/ped_global_pose@geometry_msgs/msg/Pose@gz.msgs.Pose", 
        ],
        output="screen",
        parameters=[
            {'use_sim_time': True},
