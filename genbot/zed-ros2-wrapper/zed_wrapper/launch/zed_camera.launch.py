...
def launch_setup(context, *args, **kwargs):
    ...
    body_tracking = LaunchConfiguration('body_tracking')
    ...
    node_parameters.append( 
            # Launch arguments must override the YAML files values
            {
                ...
                'body_tracking.bt_enabled': body_tracking,
                'object_detection.od_enabled': object_detection,
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                'body_tracking',
                default_value='false',
                description='Enable Body tracking.',
                choices=['true', 'false']),
             DeclareLaunchArgument(
                'object_detection',
                default_value='false',
